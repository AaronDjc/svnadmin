...
public class avatarServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
			...
			if("view".equals(action)){	
				...
				String type = StringUtils.isBlank(request.getParameter("type")) ? "middle":request.getParameter("type");
				
				String imagepath="avatar/"+name+"_"+type+".jpg";
				java.io.File file=new java.io.File(request.getRealPath(imagepath));    
				if(!file.exists())    
				{
					imagepath = "avatar/avatar_"+type+".jpg";
				}
				FileInputStream hFile = new FileInputStream(request.getRealPath(imagepath)); 
