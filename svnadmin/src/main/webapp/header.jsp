...
<div id="top">
    <div class="top-wrapper">
        ...
        <ul class="topnav">
            <li class="topuser"> 
                <a title="" data-toggle="dropdown"><img src="<%=ctx%>/avatar/<%=_usr.getUsr() %>_small.jpg" style="width:30px;height" onerror="this.src='<%=ctx%>/resources/images/user.png';"><span><%=_usr.getUsr()%></span><i class="caret"></i></a>
...
<div class="wrapper">
    ...
    <div class="sidebar" id="left-sidebar">
    		...
    		<!-- standard nav -->
            <li><a href="#" title="" class="expand subClosed"><span class="menu-dashboard"></span>管理首页</a>
                <ul style="display: none;">
                    <li><a href="http://themes.kopyov.com/amsterdam/1/index.html" title="">Dark boxed</a></li>
                    <li><a href="http://themes.kopyov.com/amsterdam/2/index.html" title="">Dark unboxed</a></li>
                    <li class="current"><a href="index.html" title="">Light boxed</a></li>
                    <li><a href="http://themes.kopyov.com/amsterdam/4/index.html" title="">Light unboxed</a></li>
                </ul>
            </li>
            <li><a href="<%=ctx%>/user" title=""><span class="menu-icons"></span><%=I18N.getLbl(request,"main.link.user","用户")%></a></li>
            <li class="active"><a href="<%=ctx%>/project" title=""><span class="menu-icons"></span><%=I18N.getLbl(request,"main.link.pj","项目")%></a></li> 
			<li><a href="<%=ctx%>/i18n" title=""><span class="menu-icons"></span><%=I18N.getLbl(request,"main.link.i18n","语言")%></a></li>   
            <!-- /standard nav -->            
    		</ul>
    </div>
    <!-- /Left sidebar -->
