		...
		<div class="body">	
			...
			<div id="avatar-view-div" class="avatar-edit-grid clearfix">
				<div class="col col-1">
					...
					<div><img id="big_img" src="<%=ctx%>/avatar/<%=_usr.getUsr() %>_big.jpg" onerror="this.src='<%=ctx%>/resources/images/user.png';"/></div>
				</div>
				<div class="col col-2">
					<div class="hd"><h4>小头像：</h4></div>
					<div class="bd clearfix">
						<div class="col col-21"><img id="mid_img" src="<%=ctx%>/avatar/<%=_usr.getUsr() %>_middle.jpg" onerror="this.src='<%=ctx%>/resources/images/user.png';"/></div>
						<div class="col col-21"><img id="small_img" src="<%=ctx%>/avatar/<%=_usr.getUsr() %>_small.jpg" onerror="this.src='<%=ctx%>/resources/images/user.png';"/></div>
					</div>
				</div>
